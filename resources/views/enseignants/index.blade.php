        ...
        <form action="{{ route('enseignants.index') }}" method="GET">
            <div class="filter-grid">
                <div class="filter-field">
                    ...
                    <input type="text" name="search" class="form-control" placeholder="Nom, prénom, email..."
                ...
                <div class="filter-field">
                    ...
                    <select name="grade" class="form-select">
                        ...
                        <option value="Maitre-Assistant" {{ request('grade') == 'Maitre-Assistant' ? 'selected' : '' }}>
                    ...
                    <tbody>
                        @forelse($enseignants as $enseignant)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge {{ strtolower(trim($enseignant->statut)) == 'permanent' ? 'badge-green' : 'badge-orange' }}">
                        ...
                        @empty
                            ...
                            <tr>
                                ...
                                <td>{{ $enseignant->departement }}</td>
                                <td class="fw-bold">{{ number_format($enseignant->taux_horaire, 0, ',', ' ') }} FCFA
                                </td>
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('enseignants.show', $enseignant->id) }}"
                                        ...
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#deleteModal{{ $enseignant->id }}" title="Supprimer">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Tu es sûr de vouloir supprimer <strong>{{ $enseignant->prenom }}
                                                        {{ $enseignant->nom }}</strong> ?
                                                </div>
                        ...
                        <div class="dropdown d-inline-block d-md-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item btn-edit" href="#" data-id="{{ $enseignant->id }}"
                                    data-nom="{{ $enseignant->nom }}" data-prenoms="{{ $enseignant->prenoms }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="taux_horaire" class="form-control"
                                            min="1000" max="50000" step="500" placeholder="Ex: 9000"
                                            required>
