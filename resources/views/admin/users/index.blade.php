...
<x-app-layout>
    ...
    <div class="row g-4">
        ...
        <div class="modal fade" tabindex="-1" aria-labelledby="add-user-label" aria-hidden="true" id="add-user">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="add-user-label"><i class="bi bi-person-plus-fill me-2"></i>Nouvel
                            utilisateur</h5>
                        ...
                        <form method="POST" action="{{ route('admin.users.store') }}" x-data="{ role: '{{ old('role') }}' }">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex gap-2">
                                    <select name="role" class="form-select" x-model="role">
                                    ...
                                    <select name="grade" class="form-select" x-show="role === 'enseignant'" x-cloak>
                            ...
                            {{-- departement si enseignant --}}
                            <div class="mb-3" x-show="role === 'enseignant'" x-cloak>
                                <label class="form-label">Departement</label>
                                <input type="text" name="departement" class="form-control @error('departement') is-invalid @enderror"
                                    value="{{ old('departement') }}" placeholder="Ex: Génie Logiciel" list="departements-list"
                                    autocomplete="off">
