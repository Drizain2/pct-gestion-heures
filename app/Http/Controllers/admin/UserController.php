...
class UserController extends Controller
{
    public function index()
    {
        ...
        return view('admin.users.index', compact('users', 'roles', 'departements'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'grade' => 'required_if:role,enseignant|nullable|in:Assistant,Maitre-Assistant,Professeur',
            'departement'=>'required_if:role,enseignant|nullable',
        ]);

        $user = User::create([
            'name' => $request->input('prenom').' '.$request->input('name'),
